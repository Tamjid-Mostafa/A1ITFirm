...
const WhyA1ITFirm = () => {
  return (
    <Container className={cn(s.root, 'fit my-10 rounded-lg p-10')}>
      <Text variant='heading' className='text-start text-4xl mb-5'>Why A1iTFirm?</Text>
